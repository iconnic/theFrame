...
import com.iconnic.worktemplate.media.exoplayer.EventLogger;
import com.iconnic.worktemplate.media.exoplayer.TrackSelectionHelper;
...
public class PlayerActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
  ...
  private DataSource.Factory buildDataSourceFactory(boolean useBandwidthMeter) {
    return ((Vault) getApplication()).buildDataSourceFactory(useBandwidthMeter ? BANDWIDTH_METER : null);
  }
  ...
  private HttpDataSource.Factory buildHttpDataSourceFactory(boolean useBandwidthMeter) {
    return ((Vault) getApplication()).buildHttpDataSourceFactory(useBandwidthMeter ? BANDWIDTH_METER : null);
  }
  ...
  private void showToast(String message) {
	toasty.showToast(getApplicationContext(),message,true);  
