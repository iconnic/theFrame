...
import com.iconnic.worktemplate.adapters.CardRoundContacts1Adapter;
...
public class Fifth extends Fragment{
	...
	public View onCreateView(LayoutInflater inflator,ViewGroup container,Bundle savedInstanceState){
		view = inflator.inflate(R.layout.fifth,container,false);
...
private void clear(){text.clear(); pic.clear();}
	...
	public void initRecycler(){	
        ...
        adapter = new CardRoundContacts1Adapter(pic,text,text,text,thewidth,theheight,"Third",gridnum,context); recycler.setAdapter(adapter);
	...
	private static void refreshRecyclerAll(){
		...
		adapter = new CardRoundContacts1Adapter(pic,text,text,text,thewidth,theheight,"Third",gridnum,context);
