...
public class Photos extends Fragment {
	...
	final static int gridnum=3;
	@Override
	public View onCreateView(LayoutInflater inflator,ViewGroup container,Bundle savedInstanceState){
		view = inflator.inflate(R.layout.photos,container,false);
	...
	public void initRecycler(){	
		...
		double viewheight=((float)(MainActivity.theheight))/4; int theheight=(int) viewheight;
        ...
        adapter = new CardPhoto1Adapter(pic,thewidth,theheight,"Photos",gridnum,context); recycler.setAdapter(adapter);
	...
	private static void refreshRecyclerAll(){
		...
		adapter = new CardPhoto1Adapter(pic,thewidth,theheight,"Photos",gridnum,context);
