...
import com.iconnic.worktemplate.adapters.CardVideo1Adapter;
...
public class Videos extends Fragment {
	...
	public View onCreateView(LayoutInflater inflator,ViewGroup container,Bundle savedInstanceState){
		view = inflator.inflate(R.layout.videos,container,false);
...
private void clear(){text.clear(); pic.clear();}
	...
	public void initRecycler(){	
        ...
        adapter = new CardVideo1Adapter(pic,text,thewidth,theheight,"Videos",gridnum,context); recycler.setAdapter(adapter);
	...
	private static void refreshRecyclerAll(){
		...
		adapter = new CardVideo1Adapter(pic,text,thewidth,theheight,"Videos",gridnum,context);
