...
import com.iconnic.worktemplate.views.SnappingRecyclerView;
...
public class FirstONE extends Fragment{
	...
	public View onCreateView(LayoutInflater inflator,ViewGroup container,Bundle savedInstanceState){
		view = inflator.inflate(R.layout.firstone,container,false);
	...
	public void initRecycler(){	
        ...
        adapter = new CardRound1Adapter(pic,text,thewidth,theheight,"FirstONE",gridnum,context); recycler.setAdapter(adapter);
	...
	private static void refreshRecyclerAll(){
		...
		adapter = new CardRound1Adapter(pic,text,thewidth,theheight,"FirstONE",gridnum,context);
