...
public class FirstTHREE extends Fragment{
private static Activity activity; private static Context context; private static View view;
	...
	public View onCreateView(LayoutInflater inflator,ViewGroup container,Bundle savedInstanceState){
		view = inflator.inflate(R.layout.firstthree,container,false);
	...
	public void initRecycler(){	
        ...
        adapter = new CardBanner1Adapter(pic,text,text,thewidth,theheight,"FirstTHREE",gridnum,context); recycler.setAdapter(adapter);
	...
	private static void refreshRecyclerAll(){
		...
		adapter = new CardBanner1Adapter(pic,text,text,thewidth,theheight,"FirstTHREE",gridnum,context);
