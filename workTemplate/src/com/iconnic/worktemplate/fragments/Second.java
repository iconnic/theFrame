...
public class Second extends Fragment{
	...
	public View onCreateView(LayoutInflater inflator,ViewGroup container,Bundle savedInstanceState){
		view = inflator.inflate(R.layout.second,container,false);
	...
	public void initRecycler(){	
        ...
        adapter = new CardFlat1Adapter(pic,text,text,text,thewidth,theheight,"Second",gridnum,context); recycler.setAdapter(adapter);
	...
	private static void refreshRecyclerAll(){
		...
		adapter = new CardFlat1Adapter(pic,text,text,text,thewidth,theheight,"Second",gridnum,context);
	...
	private void fakeData(){
		//add the dummy menu item data in the first position
		text.add("menu"); pic.add("menu");
